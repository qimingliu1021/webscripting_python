...
for name, url in manufacturers_name_url:
    ...
    print("Total Order Number:", total_order_number)
    print("Total Order Dollar:", total_order_dollar)
    print("Main Categories: ", main_categories)
    print("Total Order so far: ", orders_so_far)
    print("MOQs: ", min_orders)
    # print("Per Order Unit:", order_unit)
    print("\n")
